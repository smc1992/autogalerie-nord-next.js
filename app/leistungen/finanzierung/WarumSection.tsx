  ...
  const gruende = [
    {
      ...
      image: '/images/Beste Konditionen-Autogalerie Nord.webp',
      stats: [
    ...
    },
    {
      ...
      image: '/images/schnelle Abwicklung-Autogalerie Nord.webp',
      stats: [
    ...
    },
    {
      ...
      image: '/images/Persönliche Finanzierungsberatung-Autogalerie Nordwebp.webp',
      stats: [
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="space-y-20">
          {gruende.map((grund, index) => (
            <div key={index} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-8 md:gap-12`}>
              {/* Content */}
              ...
              <div className="flex-1">
                <div className="relative rounded-2xl overflow-hidden shadow-xl transform hover:scale-105 transition-all duration-500 group">
                  <img 
                    src={grund.image}
                    alt={grund.title}
                    className="w-full h-64 md:h-96 object-cover object-top transform group-hover:scale-110 transition-transform duration-700"
                  />
        ...
        {/* Abschließende CTA */}
        <div className="mt-16 md:mt-20 bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl text-red-100 mb-6 md:mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                ...
                className="border-2 border-white text-white hover:bg-white hover:text-red-600 px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer inline-flex items-center justify-center"
              >
