    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
          {dict.ueberuns.contactSection.title}
        </h2>
        <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
          {dict.ueberuns.contactSection.subtitle}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-red-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">{dict.ueberuns.contactSection.phoneTitle}</h3>
            <a 
            ...
            <p className="text-gray-400 mt-2">{dict.ueberuns.contactSection.phoneHours}</p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-red-500/50 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">{dict.ueberuns.contactSection.emailTitle}</h3>
            <a 
            ...
            <p className="text-gray-400 mt-2">{dict.ueberuns.contactSection.emailFastResponse}</p>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-12">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">{dict.ueberuns.contactSection.visitTitle}</h3>
          <p className="text-gray-300 text-lg">{dict.ueberuns.contactSection.visitCity}</p>
          <p className="text-gray-400 mt-2">{dict.ueberuns.contactSection.visitVehiclesAvailable}</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            {dict.ueberuns.contactSection.ctaCallNow}
          </a>
          <a 
            href="mailto:info@autogalerie-nord.de"
          ...
          >
            ...
            {dict.ueberuns.contactSection.ctaEmailSend}
          </a>
        </div>
      </div>
    </section>
